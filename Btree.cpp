...
int main() {
    ...
    printf("B-Tree(M: %d) 1000개 삽입, 500개 삭제 시간 : %fms\n\n\n",M, result); // 1000개 삽입, 500개 삭제 예제 실행
    btree.traverse();
}